...
class STLS1(object):
    ...
    def create_stream (self):
        ...
        # define two vars
        vm.var(name = "ip_src", min_value = "16.0.0.0", max_value = "16.0.0.2", size = 4, op = "random")
        vm.var(name = "src_port", min_value = 1025, max_value = 1026, size = 2, op = "random")
